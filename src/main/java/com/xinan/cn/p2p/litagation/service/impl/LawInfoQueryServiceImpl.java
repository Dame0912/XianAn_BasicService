...
//    }
//
//    private void handleUnclearLawInfo(List<LawLoanerBasicInfo> LawLoanerBasicInfoList) throws Exception {
//        log.info("LawInfoQueryServiceImpl.handleUnclearLawInfo，开始，请求数量size:" + LawLoanerBasicInfoList.size());
//        List<CasesLoanerInfo> insertCases = new ArrayList<>();//插入的cases
//        List<CasesLoanerInfo> updateNaturalCases = new ArrayList<>();//个人更新的cases
//        List<CasesLoanerInfo> updateCompanyCases = new ArrayList<>();//企业更新的cases
//
//        // 个人
...
//        List<LawLoanerBasicInfo> queryNaturalLoaners = fdUserMapper.batchQueryLoaner(naturalLoanerList);
